...
export class AuthService {
    ...
    login(email: string, password: string): Observable<User> {
        return this.http.post<User>(this.baseUrl + API_USERS_URL + "/login", { email, password });
    }
    ...
    register(user: User): Observable<any> {
        ...
        return this.http.post<User>(this.baseUrl + API_USERS_URL, user, { headers: httpHeaders })
            .pipe(
                map((res: User) => {
                    return res;
                }),
    ...
    public requestPassword(email: string): Observable<any> {
    	return this.http.get(this.baseUrl + API_USERS_URL + '/forgot?=' + email)
	...
	updateUser(_user: User): Observable<any> {
        const httpHeaders = new HttpHeaders();
        httpHeaders.set('Content-Type', 'application/json');
		return this.http.put(this.baseUrl + API_USERS_URL, _user, { headers: httpHeaders });
	}
	...
	findUsers(queryParams: QueryParamsModel): Observable<QueryResultsModel> {
        const httpHeaders = new HttpHeaders();
        httpHeaders.set('Content-Type', 'application/json');
		return this.http.post<QueryResultsModel>(this.baseUrl + API_USERS_URL + '/findUsers', queryParams, { headers: httpHeaders});
    }
    ...
    getRolePermissions(roleId: number): Observable<Permission[]> {
        return this.http.get<Permission[]>(this.baseUrl + API_PERMISSION_URL + '/getRolePermission?=' + roleId);
    }
	...
	createRole(role: Role): Observable<Role> {
		...
		return this.http.post<Role>(this.baseUrl + API_ROLES_URL, role, httpOptions);
	}
    ...
    findRoles(queryParams: QueryParamsModel): Observable<QueryResultsModel> {
        ...
        const httpHeaders = new HttpHeaders();
        httpHeaders.set('Content-Type', 'application/json');
		return this.http.post<QueryResultsModel>(this.baseUrl + API_ROLES_URL + '/findRoles', queryParams, { headers: httpHeaders});
	}
    ...
    getAllBranch(): Observable<Branch[]> {
        ...
        return this.http.get<Branch[]>(this.baseUrl + API_BRANCH_URL, httpOptions);
    }
    ...
    findBranches(queryParams: QueryParamsModel): Observable<QueryResultsModel> {
        ...
        const httpHeaders = new HttpHeaders();
        httpHeaders.set('Content-Type', 'application/json');
		return this.http.post<QueryResultsModel>(this.baseUrl + API_BRANCH_URL + '/findBranches', queryParams, { headers: httpHeaders});
	}
    ...
    updateBranch(branch: Branch): Observable<any> {
		...
		return this.http.put(this.baseUrl + API_BRANCH_URL, branch, httpOptions);
	}
    ...
    createBranch(branch: Branch): Observable<any> {
		...
		return this.http.post(this.baseUrl + API_BRANCH_URL, branch, httpOptions);
	}
