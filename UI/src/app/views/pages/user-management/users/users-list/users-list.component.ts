...
import { EventBusService } from "../../../../../core/auth/_shared/event-bus.service";
...
export class UsersListComponent implements OnInit, OnDestroy {
	...
	ngOnInit() {
		...
		**/
		...
		// Init DataSource
		this.dataSource = new UsersDataSource(this.store, this.eventBusService);
	...
	getOccupationStr(user: User): string {
		...
		const _occu = find(
			this.occupations,
			(occu: Occupation) => occu.occupation === user.occupation
		);
		if (_occu) {
			titles = _occu.descr;
		}
